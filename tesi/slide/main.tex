...
% autore
\author{\footnotesize\hfill\; Relatore: Luchetta Antonio\hfill Relatore: Manetti Stefano\hfill\;\\\small \textbf{Candidato: Caini Michele}}
% data
\date{9 Luglio 2010}
% università (breve)
\institute[Università degli Studi di Firenze, Facoltà di Ingegneria]
% università (esteso)
 {Università degli Studi di Firenze, Facoltà di Ingegneria\\ Corso di Laurea Specialistica in Ingegneria Informatica}
% corso di laurea
\newcommand{\cdl}{Corso di Laurea Specialistica in Ingegneria Informatica}
